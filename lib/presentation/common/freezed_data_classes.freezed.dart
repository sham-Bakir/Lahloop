...
class _$LoginObjectImpl implements _LoginObject {
  _$LoginObjectImpl(this.phoneNumber, this.password);
  ...
  @override
  String toString() {
    return 'LoginObject(phoneNumber: $phoneNumber, password: $password)';
  }
...
abstract class _LoginObject implements LoginObject {
  factory _LoginObject(final String phoneNumber, final String password) =
      _$LoginObjectImpl;
